...
<html lang="en">
<head>
  <title>Shed_54 Hens Summary</title>
  <meta charset="UTF-8">
  ...
  <div id="wrapper">
    <!-- START NAV -->
     <nav id="nav" class="column">
         <img src="<?php echo base_url('css/img/hen3.jpg'); ?>"  width="180" height="180" alt="chook logo" title="UNE" />
    ...
    <section id="col_mid" class="column">
      <header>
        <h1 id="shed_54">Shed_54 Hens Summary</h1>
      </header>
      <!-- START UNIT INFO -->
...
//                   echo form_close();
       ...
       <table id='result_table' class="table table-bordered">  
           <thead>
                          <tr>  
                               <th class="shed_54_th">antenna_name</th>  
                               <th class="shed_54_th"width="30%">leaves</th>  
                               <th class="shed_54_th">enters</th>  
                          </tr>  
           </thead>
           <tbody>    
     </tbody>
   ...
   <span><i class="fa fa-refresh fa-spin fa-3x"></i></span>
       ...
       <table id='result_table_reader' class="table table-bordered">  
           <thead>
                          <tr>  
                               <th class="shed_54_th">reader_name</th>  
                               <th class="shed_54_th">leaves</th>  
                               <th class="shed_54_th">enters</th>  
                          </tr>  
           </thead>
           <tbody>    
       ...
       $(document).ready(function() {
              ...
              $('#spinner').show();
                ...
                if($('#ShowantennaDate').val() !== ''){
                 ...
                 $.ajax({ 
                           ...
                           crossDomain: true,
                           dataType: "jsonp",
                           url: "http://turing.une.edu.au/~srallaba/CodeIgniter5/api/Api_54/antenna_report?date=" + selectedDate,                                            success: function (result) {
          ...
          var selectedValue = $(this).val();
            ...
            $.ajax({ 
                           ...
                           crossDomain: true,
                           dataType: "jsonp",
                           url: "http://turing.une.edu.au/~srallaba/CodeIgniter5/api/Api_54/antenna_report?date=" + selectedDate,   
           ...
           $('#reader').click(function () {
                ...
                if($('#ShowreaderDate').val() !== ''){
                 ...
                 $.ajax({ 
                           ...
                           crossDomain: true,
                           dataType: "jsonp",
                           url: "http://turing.une.edu.au/~srallaba/CodeIgniter5/index.php/api/Api_54/reader_report?date=" + selectedDate,                                            success: function (result) {
                        if (jQuery.isEmptyObject(result)) {
                            var $tr = $('<tr>').append(
                               $('<td colspan="4">').text('NO RECORDS FOUND')
        ...
        $(document).ready(function() {
            ...
            var selectedValue = $(this).val();
                 ...
                 $.ajax({ 
                           ...
                           crossDomain: true,
                           dataType: "jsonp",
                           url: "http://turing.une.edu.au/~srallaba/CodeIgniter5/index.php/api/Api_54/epc_report",                                            success: function (result) {
